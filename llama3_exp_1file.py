...
base_dir = "/scratch/gjf3sa/llama3/articles/batches/"

# Set up argument parser
parser = argparse.ArgumentParser(description="Process a JSON file.")
parser.add_argument("input_file", type=str, help="The JSON file to process (without the base directory)")
parser.add_argument("output_file", type=str, help="The file to save the output (without the base directory)")
